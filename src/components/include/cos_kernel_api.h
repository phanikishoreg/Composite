...
int cos_hithd_switch(thdcap_t c, tcap_t tc, tcap_prio_t prio, tcap_time_t timeout, arcvcap_t rcv, sched_tok_t stok, tcap_t hitc, tcap_prio_t hiprio);
...
int cos_rcv_schedprio(arcvcap_t rcv, rcv_flags_t flags, arcvcap_t srcv, tcap_prio_t prio, int *rcvd);
...
int cos_hw_periodic_attach(hwcap_t hwc, arcvcap_t rcvcap, u32_t period);
